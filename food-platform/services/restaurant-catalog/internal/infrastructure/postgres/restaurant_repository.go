...
func scanRestaurant(s scanner) (*domain.Restaurant, error) {
        ...
        r := domain.ReconstructRestaurant(
                id, name, slug, cuisines,
                rating, ratingCount, logoURL, coverURL,
                lat, lng, address, city, isOpen, domain.RestaurantStatus(status),
                etaMin, etaMax, deliveryFee, priceRange, commissionRate,
