...
func scanSession(s scanner) (*domain.Session, error) {
        ...
        session := domain.ReconstructSession(
                id, userID,
                refreshToken, deviceFingerprint, userAgent, ipAddress,
...
func scanRefreshToken(s scanner) (*domain.RefreshToken, error) {
        ...
        return domain.ReconstructRefreshToken(id, userID, sessionID, token, expiresAt, createdAt, usedAt), nil
}
